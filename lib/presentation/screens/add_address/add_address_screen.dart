...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  late AddAddressPresenter _presenter;

  @override
  void initState() {
    super.initState();
    _presenter = context.read<AddAddressPresenter>();
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: heightInputField,
                    child: Selector<AddAddressPresenter, List<PlaceEntity>>(
                      selector: (_, presenter) => presenter.provinces,
                      builder: (_, provinces, __) =>
                          Selector<AddAddressPresenter, PlaceEntity?>(
                  ...
                  Padding(
                    ...
                    child: Selector<AddAddressPresenter, bool>(
          ...
          Selector<AddAddressPresenter, bool>(
