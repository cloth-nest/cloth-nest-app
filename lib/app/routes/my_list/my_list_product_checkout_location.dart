...
class MyListProductCheckOutLocation extends BeamLocation<BeamState> {
  MyListProductCheckOutLocation([super.routeInformation]);

  @override
  List<BeamPage> buildPages(BuildContext context, BeamState state) {
    final myListProductLocation = MyListProductLocation();
    ...
    return pages
      ..add(
        BeamPage(
          key: ValueKey('my-list-product-checkout-$variantId'),
