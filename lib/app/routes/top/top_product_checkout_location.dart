...
class TopProductCheckOutLocation extends BeamLocation<BeamState> {
  TopProductCheckOutLocation([super.routeInformation]);

  @override
  List<BeamPage> buildPages(BuildContext context, BeamState state) {
    final topProductLocation = TopProductLocation();
