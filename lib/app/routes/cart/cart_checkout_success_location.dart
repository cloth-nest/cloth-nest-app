...
class CartCheckOutSuccessLocation extends BeamLocation<BeamState> {
  CartCheckOutSuccessLocation([super.routeInformation]);

  @override
  List<BeamPage> buildPages(BuildContext context, BeamState state) {
    final cartCheckOutLocation = CartCheckOutLocation();
